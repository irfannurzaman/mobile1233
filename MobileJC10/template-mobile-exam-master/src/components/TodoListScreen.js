...
const TodoListScreen = props => {
    ...
    const buttonOnAdd = () => {
        ...
        if (buttonOnAdd == button){
             <Button style={{ padding: 10 }}>
                                <Text style={{ color: 'success'}}>{item.status}finished</Text>
            </Button>
        }
    }
        ...
        <Container>
            ...
            <Content>
                ...
                renderRow={item => {
                    ...
                    <ListItem>
                        <Left>
                            <Button onPress={buttonOnAdd} info style={{ padding: 10 }}>
                      ...
                      <Button primary onPress={() => props.navigation.navigate('TodoDetailScreen',{
                              nama : 'Irfan Nurzaman'
                          })}>
